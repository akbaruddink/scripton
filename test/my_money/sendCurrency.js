...
module.exports = function(server) {
  describe("Send Currency Scenario : ", function() {

    it("Missing Client ID, It Should Return Error",function(done){
      this.timeout(10000)
      // calling home page api
      server
      .post("/api/my-money/send/currency")
    ...
    it("Missing Amount, It Should Return Error",function(done){
      ...
      .post("/api/my-money/send/currency")
      .set({access_token: nconf.get('access_token')})
      .send({recieverClientId: "91000001"})
      .expect("Content-type",/json/)
      .expect(400) // THis is HTTP response
      .end(function(err,res){
        // HTTP status should be 200
    ...
    it("Missing Nothing, It Should Return Bad Request Because No Balance",function(done){
      ...
      .post("/api/my-money/send/currency")
      .set({access_token: nconf.get('access_token')})
      .send({recieverClientId: "910000002", amount: "1"})
      .expect("Content-type",/json/)
